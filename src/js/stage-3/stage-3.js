...
import {deleteElementsFromFirstArray} from './deleteElementsFromFirstArray.js';
...
import {searchForMissingSymbol,searchForMissingSymbolAlt} from './searchForMissingSymbol.js';
import {deleteNotUnique} from './deleteNotUnique.js';
...
// console.log(deleteElementsFromFirstArray([1,2,4],[2,3,5]));
