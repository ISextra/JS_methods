describe("реализация функций: map, filter, find, some, every", function() {
    describe("map prototype", function () {
        console.log("testing works: map prototype");
    ...
    describe("filter prototype", function () {
        console.log("testing works: filter prototype");
    ...
    describe("find prototype", function () {
        console.log("testing works: find prototype");
    ...
    describe("some prototype", function () {
        console.log("testing works: some prototype");
    ...
    describe("every prototype", function () {
        console.log("testing works: every prototype");
